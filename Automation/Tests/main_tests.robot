...
Users Can Access Different Category Pages and Visualise its Contents Properly
    # PRE CONDITION
    [Setup]    generics.Open URL to Page    ""
    # TEST SCENARIO
    #    page1
    storePage.Check if Loaded Content is Correct
    storePage.Go to Another Page Using the Navbar    6
    #    page2
    storePage.Check if Loaded Content is Correct
    storePage.Go to Another Page Using the Navbar    5
    #    page3
    storePage.Check if Loaded Content is Correct